...
<section>
	...
	<div class="container" style="text-align: center;">
		...
		<div class="container table-responsive">
			...
			<thead>
				<tr>
					<th data-sortable="True">idAutor</th>
			...
			<tbody>
				<c:forEach var ="item" items= "${autores}">
					<tr>
						...
						<td>${item.correo}</td>		
						<td>
							<button class="btn btn-success" onClick="window.location.href='/ismac-libreria-web/autores/findOne?opcion=1&idAutor=${item.idAutor}'">Actualizar</button>
							<button class="btn btn-danger" onClick="window.location.href='/ismac-libreria-web/autores/findOne?opcion=2&idAutor=${item.idAutor}'">Borrar</button>
						</td>
					</tr>
				</c:forEach>
